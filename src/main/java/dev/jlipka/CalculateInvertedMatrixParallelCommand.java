...
public class CalculateInvertedMatrixParallelCommand implements Command<double[][]>{
    String UNIQUE_BINDING_NAME = "matrix.calculator";
    private final MatrixCalculator matrixCalculator;
    private final double[][] matrix;
    private final int threads;

    public CalculateInvertedMatrixParallelCommand(double[][] matrix, int threads) throws RemoteException, NotBoundException {
        this.matrix = matrix;
    ...
    public double[][] execute() throws InterruptedException, RemoteException {
        return matrixCalculator.invertParallel(matrix, threads);
    }
}
